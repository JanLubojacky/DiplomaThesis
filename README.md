...
## Using BRCA data citation
Acknowledgement Statement: Please cite/reference the use of dbGaP data by including the dbGaP accession phs000178.v11.p8. Additionally, use the following statement to acknowledge the submitter(s) of this study:
